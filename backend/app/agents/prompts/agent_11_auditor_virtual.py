...
Output JSON (estructura PAC 4 fases + 4 preguntas + narrativa):
{
    ...
    "fases": [
      {"fase_num": 1, "titulo": "Bloqueantes sanidad datos salud", "periodo_semanas": "0-4",
       "acciones": [
         ...
         {"id": "PAC-F1-002", "nc_origen": "op.acc.6", "accion": "MFA obligatorio Azure AD todos los usuarios con acceso HCE.", "responsable_sugerido": "IT + RSEG", "esfuerzo_dias": 3, "evidencia_esperada": "Politica CAP + log MFA 100% users", "prioridad": "critica", "rationale_sector": "Acceso HCE sin MFA expone datos art. 9 RGPD."}
       ],
  ...
  "narrativa_ejecutiva": {
    ...
    "riesgos_principales": [
      ...
      "Si el MFA rollout tiene fricciones operativas, op.acc.6 podria arrastrarse.",
