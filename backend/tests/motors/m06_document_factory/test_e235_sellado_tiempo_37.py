"""#37 OlaIV · E-235 Procedimiento de Sellado de Tiempo (mp.info.5).

La medida mp.info.5 (Sellos de tiempo) es refuerzo solo-ALTA. Decisión #37:
...
def test_e235_covers_measure_and_eidas_framework():
    ...
    assert "mp.info.5" in body  # medida canónica del sistema (audit_sim)
...
def test_e235_alta_only_and_honest_gap():
    ...
    assert "PENDIENTE REVISIÓN CONSULTOR" in body
