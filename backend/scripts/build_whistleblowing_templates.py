"""Sub-lote 1.B.8.B · Compila los templates Whistleblowing W-001 + W-002 a DOCX.

Patron heredado de build_proveedores_templates.py / build_tecnicos_templates.py
adaptado a TEMPLATES en multiples subdirectorios (policies/ + procedures/ vs
todos en deliverables/).

W-* son plantillas adyacentes normativa NO-ENS (Ley 2/2023 Whistleblowing).
Codigos W-001/002 segregados del rango E-1XX/E-2XX por clara separacion
normativa (LECCION-OPS-032 + AMEND-016 v2).

Uso:
    PYTHONPATH=. python backend/scripts/build_whistleblowing_templates.py
"""
...
TEMPLATES = [
    ("W-001", "policies", "W001_politica_sistema_interno_informacion.md"),
    ("W-002", "procedures", "W002_procedimiento_gestion_denuncias_proteccion_informante.md"),
]
...
def main() -> int:
    ...
    print(f"\n=== {len(TEMPLATES)} templates Whistleblowing construidos ===")
    return 0
