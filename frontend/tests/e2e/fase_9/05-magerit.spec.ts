...
/**
 * FASE 9.D · canonical regression spec /admin/projects/[id]/magerit.
 *
 * Verifica:
 ...
 */
test("9.D.5 /magerit renders + sidebar gradient + 0 critical errors", async ({
  page,
  context,
}) => {
  ...
  await page.goto(`/admin/projects/${SEED}/magerit`);
