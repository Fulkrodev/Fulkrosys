...
/**
 * FASE 9.D · canonical regression spec /admin/projects/[id]/evidence.
 *
 * Verifica:
 ...
 *
 * No assertions sobre datos específicos · proyecto seed puede tener o
 * no evidencias y queremos red de seguridad estable.
 */
test("9.D.1 /evidence renders + sidebar gradient + 0 critical errors", async ({
  page,
  context,
}) => {
  ...
  await page.goto(`/admin/projects/${SEED}/evidence`);
