...
/**
 * FASE 9.D · canonical regression spec /admin/projects/[id]/diagnosis.
 *
 * Verifica:
 ...
 */
test("9.D.4 /diagnosis renders + sidebar gradient + 0 critical errors", async ({
  page,
  context,
}) => {
  ...
  await page.goto(`/admin/projects/${SEED}/diagnosis`);
