...
/**
 * FASE 9.D · canonical regression spec /admin/projects/[id]/obligations.
 *
 * Verifica:
 ...
 */
test("9.D.6 /obligations renders + sidebar gradient + 0 critical errors", async ({
  page,
  context,
}) => {
  ...
  await page.goto(`/admin/projects/${SEED}/obligations`);
