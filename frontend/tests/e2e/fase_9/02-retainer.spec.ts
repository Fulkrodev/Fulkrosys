...
/**
 * FASE 9.D · canonical regression spec /admin/projects/[id]/retainer.
 *
 * Verifica:
 ...
 */
test("9.D.2 /retainer renders + sidebar gradient + 0 critical errors", async ({
  page,
  context,
}) => {
  ...
  await page.goto(`/admin/projects/${SEED}/retainer`);
