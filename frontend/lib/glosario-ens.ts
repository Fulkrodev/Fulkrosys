...
export const GLOSARIO_ENS = {
  ...
  Anexo_III: { label: "Anexo III", definition: "Cómo se audita el ENS. En MEDIA/ALTA hace falta un auditor ENAC externo cada 2 años · en BÁSICA basta una autoevaluación (verificación CCN-STIC 808) y la Declaración de Conformidad (CCN-STIC 809) · RD 311/2022 art. 38.1." },
  ...
  CCN_STIC_809: { label: "CCN-STIC 809", definition: "Guía oficial de la Declaración de Conformidad y los distintivos del ENS. En BÁSICA, tras la autoevaluación, tu organización firma la declaración · sin auditor externo. En MEDIA/ALTA no basta: hace falta certificación." },
  ...
  workflow_conformidad: { label: "Fase Conformidad", definition: "Dossier ENAC preparado. En MEDIA/ALTA viene el auditor externo · en BÁSICA tu organización hace la autoevaluación (CCN-STIC 808) y firma la Declaración de Conformidad (CCN-STIC 809)." },
