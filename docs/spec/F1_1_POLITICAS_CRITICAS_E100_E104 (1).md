# F1.1 — POLÍTICAS CRÍTICAS DEL SGSI ENS — TEXTO LEGAL REAL EN ESPAÑOL (E-100 a E-109)
...
```python
# Modelo de datos requerido por las 5 políticas E-100 a E-109
{
    "cliente": {
...
2. **Por cada política** (E-100 a E-109):
...
- **E-107** Política de Cifrado y Gestión de Claves Criptográficas
- **E-103** Política de Uso Aceptable de los Recursos
- **E-112** Política de Seguridad en las Relaciones con Proveedores
- **E-104** Política de Clasificación y Tratamiento de la Información
