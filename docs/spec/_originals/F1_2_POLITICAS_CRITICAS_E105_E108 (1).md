# F1.2 — POLÍTICAS CRÍTICAS DEL SGSI ENS — TEXTO LEGAL REAL EN ESPAÑOL (E-105 a E-108)
...
# DOCUMENTO E-105 — POLÍTICA DE CIFRADO Y GESTIÓN DE CLAVES CRIPTOGRÁFICAS
...
En caso de compromiso o sospecha fundada de compromiso de cualquier clave criptográfica, el Responsable del Sistema notificará inmediatamente al Responsable de la Seguridad, quien activará el procedimiento de gestión de incidentes ({{ proyecto.codigo_documento_base }}-103) y procederá a:
...
Cuando la información de la Entidad sea tratada por proveedores cloud o externos, las cláusulas contractuales correspondientes (conforme al documento {{ proyecto.codigo_documento_base }}-107, Política de Seguridad en las Relaciones con Proveedores) garantizarán que:
...
# DOCUMENTO E-106 — POLÍTICA DE USO ACEPTABLE DE LOS RECURSOS
...
# DOCUMENTO E-107 — POLÍTICA DE SEGURIDAD EN LAS RELACIONES CON PROVEEDORES
...
c) **Cifrado de los datos en reposo y en tránsito** conforme a los requisitos del documento {{ proyecto.codigo_documento_base }}-105.
...
Solo se utilizará software con soporte vigente del fabricante y se aplicarán los parches de seguridad publicados conforme a los plazos establecidos en el procedimiento {{ proyecto.codigo_documento_base }}-218 (Procedimiento de Gestión de Vulnerabilidades).
...
# DOCUMENTO E-108 — POLÍTICA DE CLASIFICACIÓN Y TRATAMIENTO DE LA INFORMACIÓN
...
El acceso a la información se rige por el principio de necesidad de saber, conforme se desarrolla en el documento {{ proyecto.codigo_documento_base }}-102.
...
La clasificación inicial de la información corresponde al **Responsable de la Información** (rol del artículo 11 del ENS), conforme se desarrolla en el documento {{ proyecto.codigo_documento_base }}-101, en coordinación con quien la haya generado o capturado.
...
Cuando la destrucción se confíe a proveedores especializados, estos cumplirán las exigencias del documento {{ proyecto.codigo_documento_base }}-107 (Política de Seguridad en las Relaciones con Proveedores) y emitirán los correspondientes certificados de destrucción.
...
| E-101 | Roles, Responsabilidades y Autoridades de Seguridad | F1.1 | ✅ Completa |
| E-102 | Política de Control de Acceso | F1.1 | ✅ Completa |
| E-103 | Política de Gestión de Incidentes de Seguridad | F1.1 | ✅ Completa |
| E-104 | Política de Continuidad del Servicio | F1.1 | ✅ Completa |
| E-105 | Política de Cifrado y Gestión de Claves Criptográficas | **F1.2** | ✅ Completa |
| E-106 | Política de Uso Aceptable de los Recursos | **F1.2** | ✅ Completa |
| E-107 | Política de Seguridad en las Relaciones con Proveedores | **F1.2** | ✅ Completa |
| E-108 | Política de Clasificación y Tratamiento de la Información | **F1.2** | ✅ Completa |
...
| **org.2** Normativa de seguridad | E-100 a E-108 (transversal) |
| **org.3** Procedimientos de seguridad | E-100 (apunta a los procedimientos del bloque F2) |
| **org.4** Proceso de autorización | E-106, E-107 |
| **op.acc.1 a op.acc.6** Control de acceso | E-102 |
| **op.exp.7** Gestión de incidentes | E-103 |
| **op.cont.1 a op.cont.4** Continuidad | E-104 |
| **op.ext.1 a op.ext.4** Servicios externos | E-107 |
| **mp.info.1 a mp.info.6** Información | E-108 |
| **mp.info.3** Cifrado | E-105 |
| **mp.com.2 / mp.com.3** Comunicaciones | E-105 |
| **mp.si.2** Criptografía | E-105 |
| **mp.eq.1 a mp.eq.4** Equipos | E-106 |
| **mp.s.1** Servicios | E-106 |
...
- **F2 — 12+ procedimientos críticos** (E-200 a E-228 selección): los procedimientos operativos detallados que ejecutan lo que las políticas declaran. Es donde Marcos pasa más horas durante la implantación porque cada uno requiere instrucciones paso a paso adaptadas al cliente.
